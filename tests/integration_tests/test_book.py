...
def test_book_places(
    mocker, client, competitions_fixture, clubs_fixture, placesRequired
):
    mocker.patch.object(server, "competitions", competitions_fixture)
    mocker.patch.object(server, "clubs", clubs_fixture)
...
def test_book_places_more_than_total_max(
    mocker, client, competitions_fixture, clubs_fixture
):
    """
