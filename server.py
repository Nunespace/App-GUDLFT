...
def purchasePlaces():
    ...
    placespurchased_after_book = competition[club_name]+int(placesRequired)
    ...
    print(placespurchased_after_book)
    if placesRequired > 12 or placespurchased_after_book >= 12:
